...
interface Props {
  ...
  setIsEndMeetAlertOpen: Dispatch<SetStateAction<boolean>>
}
export const EndMeetAlert = ({
  isMeetStart,
  setIsMeetStart,
  setIsEndMeetAlertOpen,
}: Props) => {
  return (
    <div className="w-[467px] h-[372px] bg-white rounded-[5px]">
      <div>
        <div className="text-[#605BFF] inline-flex items-center mx-[120px] mt-[45px]">
          <div>
            <svg
              width="29"
              height="25"
          ...
          <div className="text-[22px] leading-[30px] font-bold pl-[8px]">
            1:1 with John Doe
          </div>
        </div>
        <div className="mx-[59px] pt-[24px] text-[20px] text-black text-center font-semibold">
          <h1>
            We noticed that you have uncovered discussion items in your meeting.
          </h1>
          <h1 className="pt-3">
            You can “Go back” and recheck them (or) “Continue” to forward all
            the items to your next meeting.
          </h1>
        </div>
        <div className="pt-[26px] flex justify-center items-center text-white text-sm font-medium">
          <div
            className="w-[100px] h-[35px] bg-[#F89821] rounded-[5px]  mr-[14px] flex justify-center items-center cursor-pointer"
            onClick={() => {
              setIsEndMeetAlertOpen(false)
            }}
          >
            Go Back
          </div>
          <Link href="/" passHref>
            <div
              className="w-[100px] h-[35px] bg-[#605BFF] rounded-[5px] flex justify-center items-center cursor-pointer"
              onClick={() => {
                setIsEndMeetAlertOpen(false)
